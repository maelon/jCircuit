...
var ParallelCircuit = function (_Circuit) {
    ...
    * @constructor
    */
    function ParallelCircuit(name) {
        _classCallCheck(this, ParallelCircuit);

        return _possibleConstructorReturn(this, (ParallelCircuit.__proto__ || Object.getPrototypeOf(ParallelCircuit)).call(this, name));
    }
...
var SerialCircuit = function (_Circuit) {
    ...
    * @constructor
    */
    function SerialCircuit(name) {
        _classCallCheck(this, SerialCircuit);

        return _possibleConstructorReturn(this, (SerialCircuit.__proto__ || Object.getPrototypeOf(SerialCircuit)).call(this, name));
    }
    ...
    _createClass(Line, [{
        ...
        */
        ...
        value: function process() {
            ...
            var _loop = function _loop(i) {
                elements_promise = elements_promise.then(function (ret, name) {
                    if (ret === _index4.default.LINE_SWITCH_OFF || _this2._switch_state === 'off') {
