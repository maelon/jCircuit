...
*/
var JCircuit = function (_Element) {
    _inherits(JCircuit, _Element);

    function JCircuit() {
        _classCallCheck(this, JCircuit);

        return _possibleConstructorReturn(this, (JCircuit.__proto__ || Object.getPrototypeOf(JCircuit)).apply(this, arguments));
    }
...
var Element = function () {
    ...
    _createClass(Element, [{
        ...
        value: function _run() {
            ...
            return {
                'next': function next() {
                    if (_this._next === 'input') {
                        var whether = _this.input.apply(_this, _arguments);
                        _this._next = whether ? 'process' : 'done';
                        return { 'value': whether, 'done': !whether };
                    } else if (_this._next === 'process') {
                        _this._next = 'output';
                        return { 'value': _this.process(), 'done': false };
                    } else if (_this._next === 'output') {
                        _this._next = 'done';
                        return { 'value': _this.output(), 'done': true };
                    } else if (_this._next === 'done') {
